...
public class ReviewServiceImpl implements ReviewService {
    ...
    private Page<ReviewResponseDTO> getReviewResponses(Page<Review> reviewPage) {
        List<Integer> userIds = reviewPage.getContent().stream().map(Review::getUserId).collect(Collectors.toList());
    ...
    @Override
    public ReviewResponseDTO checkExistsByMovieIdAndUserId(Integer movieId, Integer userId) {
    ...
    @Override
    public ReviewResponseDTO save(Integer userId, Integer movieId, ReviewRequestDTO reviewRequestDTO) {
