...
public interface ReviewService {
    ...
    ReviewResponseDTO checkExistsByMovieIdAndUserId(Integer movieId, Integer userId);

    ReviewResponseDTO save(Integer userId, Integer movieId, ReviewRequestDTO review);
