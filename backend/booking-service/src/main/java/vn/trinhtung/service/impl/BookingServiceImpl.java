...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public Page<BookingResponseDTO> getAllByUser(Integer userId, Integer page) {
        Sort sort = Sort.by("id").descending();
        Pageable pageable = PageRequest.of(page - 1, 10, sort);
    ...
    @Override
    public BookingDetailResponseDTO getDetailByUser(Integer userId, Integer bookingId) {
    ...
    @Override
    public CreateBookingResponseDTO create(Integer userId, BookingRequestDTO bookingRequestDto) {
