...
public class Oauth2ClientConfig {
    ...
    public ClientRegistrationRepository clientRegistrationRepository() {
        ...
        return new InMemoryClientRegistrationRepository(clientRegistrationPayment(), clientRegistration());
    }

    private ClientRegistration clientRegistrationPayment() {
        return ClientRegistration.withRegistrationId("payment-service").clientId("cinema-be")
