...
import { Button, DatePicker, Form, Select, Space, Table, Tag, Typography } from 'antd';
...
const Shows = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (value) => {
                ...
                return <Tag color='cyan'>{`${hours}:${minutes} ${day}/${month}/${year}`}</Tag>;
            }
        },
        {
            title: 'End',
            ...
            render: (value) => {
                ...
                const month = (date.getMonth() + 1).toString().padStart(2, "0");
                const year = date.getFullYear();
                return <Tag color='error'>{`${hours}:${minutes} ${day}/${month}/${year}`}</Tag>;
            }
        },
        {
            title: 'Hall',
    ...
    useEffect(() => {
        ...
        hallApi.getAll().then(res => {
            setHalls(res.map(i => ({ value: i.id, label: i.name + " - " + i.cinema.name + " - " + i.cinema.address })))
        })
            ...
            >
                ...
                <Form.Item>
                    <Space>
                        ...
                        <Button size='large' type="primary" ghost htmlType="submit" onClick={() => {
                            form.resetFields()
                        }}>
                            Reset
                        </Button>
